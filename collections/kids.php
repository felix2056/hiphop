...
<?php require_once('../products/db/kids_cat.php'); ?>


<?php
    $products = json_decode(getAllKids(), true);
?>
                            ...
                            <div class="product">
                                <a href="/products/single.php?product=<?php echo $product['id'] ?>"
                                    ...
                                    <span class="product-image-cell">
                                        <img class="img-responsive" data-orig="<?php echo $product['featured_image'] ?>"
                                ...
                                <ul class="action-links">
                                    <li>
                                        <a href="#" title="Quick View" class="quick-view-open" data-toggle="modal"
                                            ...
                                            data-target="#productQuickView-1807337586749"><i class="fa fa-eye"></i>
                                        </a>
                                    </li>
